...
if (count (profileNamespace getVariable ["ATragMX_gunList", []]) > 0) then {
	ATragMX_gunList = profileNamespace getVariable "ATragMX_gunList";
} else {
	...
	ATragMX_gunList =  [["12.7x108mm"       , 820, 500, 0.255, -0.0005600, 3.81, 0, 0.338, 0.338, 120, 0, 0, 48.28, "B_127x108_Ball"  , "5Rnd_127x108_Mag"        , 0.700, 1, "ASM" ],
...
call compile preprocessFile ("\atragmx\init.sqf");
//call compile preprocessFile ("\atragmx\fnc_sord.sqf");

["ATragMX", "ATragMX_openDialog", "Open ATragMX", { _this call compile preprocessFile "\atragmx\fnc_create_dialog.sqf"; }, { false }, [197, [false, false, false]]] call CBA_fnc_addKeybind;
