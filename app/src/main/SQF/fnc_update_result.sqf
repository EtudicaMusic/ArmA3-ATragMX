...
_elevationAbs = (ATragMX_elevationOutput select ATragMX_currentTarget);
_windageAbs = (ATragMX_windageOutput select ATragMX_currentTarget);

_elevationCur = (ATragMX_workingMemory select ATragMX_currentTarget) select 10;
_windageCur = (ATragMX_workingMemory select ATragMX_currentTarget) select 11;

_elevationRel = _elevationAbs - _elevationCur;
_windageRel = _windageAbs - _windageCur;

_lead = (ATragMX_leadOutput select ATragMX_currentTarget);
